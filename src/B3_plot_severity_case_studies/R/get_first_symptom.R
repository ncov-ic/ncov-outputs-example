get_first_symptom <- function(dat, symptom){ #when does word occur in columns
...
add_first_symptom <- function(df, symptom){
  ...
  # calc time from symptom onset to specific symptom reported
